<%@ Page Title="" Language="C#" MasterPageFile="~/Empleado/Importaciones USA/MasterPage.master" AutoEventWireup="true" CodeFile="EstadosPaquetes.aspx.cs" Inherits="Empleado_Importaciones_EstadosPaquetes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin-left: auto; margin-right: auto; width: 250px;">
        <table style="width: auto; border: 1px solid #cccccc; margin-right: 0px;" align="center">
            ...
            <tr>
                <td style="height: 1px">
                    <asp:Label ID="Label28" runat="server" Style="font-size: x-small" Text="Seleccione el lote que desee enviar."></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="right" style="text-align: center;">
                    <asp:Button ID="Contratar" runat="server" Text="Enviar Lote" Font-Size="Small" Height="37px" Width="95px" OnClick="Contratar_Click" />
                </td>
            </tr>
        </table>
    </div>
